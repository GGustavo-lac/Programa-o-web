...
function verificarNumero() {
    ...
    resultDiv.classList.remove('par', 'impar');

    if (num % 2 === 0) {
        resultDiv.classList.add('par');
        resultTitle.textContent = ' É PAR';
        
    } else {
        resultDiv.classList.add('impar');
        resultTitle.textContent = ' É ÍMPAR';
